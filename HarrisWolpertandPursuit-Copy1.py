...
class MinimumVarianceControl:
    ...
    time : array,
        intervals of time along the runs of the experiments (s)
    time_ms : array,
        intervals of time along the runs of the experiments (ms)
    ...
    v0 : integer,
        initial velocity of the target (deg/s) 
    n_iter : integer,
    ...
    **References:**
    ...
    def control_learning():#control_init=None,
                         #tau = 0.013,
                         #k=0.0001,
                         #dt=0.001,
                         #t_T=None,
